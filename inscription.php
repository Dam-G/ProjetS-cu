		...
		<table width="100%">			
			...
			<tr >
				...
				<form id="inscription" action="accueil.php" method="post">
					...
					<input type="text" name="prenom" id="prenom" placeholder="Entrez votre prenom" size="50px" required><br />
					<input type="date" name="date_naissance" id="date_naissance" placeholder="Entrez votre date de naissance" size="50px" required><br />
					<input type="text" name="adresse" id="adresse" placeholder="Entrez votre adresse" size="50px" required><br />
					<input type="text" name="email" id="email" placeholder="Entrez votre adresse e-mail" size="50px" required><br />
